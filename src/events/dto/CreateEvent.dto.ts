...
// event image, event name, event description
// event start_date, event end_date, event location
// event type (conference, workshop, seminar, etc.)
// is_virtual, is_active, is_public, is_private, is_paid
// event cost, max_attendees, registration_deadline
// created_at, updated_at
// event belongs to embassy_id
